...
build_path = current_path + "\\build_splboot"
uboot_itb_file_path = build_path + "\\load_bin\\u-boot.itb"
...
def task1():
    ...
    sf.load_uboot(build_path, spl_load_time)

    test_uart.splboot(COMPORT_UNIT_1, current_path, uboot_itb_file_path)
