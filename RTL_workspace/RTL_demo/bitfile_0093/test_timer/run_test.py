...
build_path_sifive = current_path + '\\build_sifive'
...
def task2():
    sf.program_FPGA(build_path_sifive)
    sf.load_uboot(build_path_sifive, load_time)

    test_timer.run_test_SIFIVE_ticktimer(COMPORT_UNIT_2, current_path)
