...
def task1():
    ...
    test_sdmmc.SD_basic_test(COMPORT_UNIT_2, current_path)
...
def task2():
    ...
    # Specify the device to load Uboot proper as SPL boot preparation
    test_sdmmc.SD_load_FAT_uboot_img(COMPORT_UNIT_2, current_path, dev='1')
    sf.load_uboot_endtask()
...
def task3():
    ...
    test_sdmmc.SD_spl_boot(COMPORT_UNIT_2, current_path)
    sf.load_uboot_endtask()
