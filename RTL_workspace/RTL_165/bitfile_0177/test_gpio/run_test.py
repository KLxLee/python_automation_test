...
def task1():
    ...
    test_gpio.run_test(COMPORT_UNIT_2, current_path)
...
def main():
    ...
    test_gpio.all_gpio_bankname = ["SYS_EAST_GPIO", "SYS_WEST_GPIO"]
    test_gpio.all_gpio_pinnum = [48, 16]
    test_gpio.GPIO_BANKNAME = "SYS_EAST_GPIO"
    test_gpio.GPIO_PIN_1 = 43     # RPI pin 35
    test_gpio.GPIO_PIN_2 = 44     # RPI pin 36
