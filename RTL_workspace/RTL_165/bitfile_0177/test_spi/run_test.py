...
def task1():
    ...
    test_spi.run_test_loopback(COMPORT_UNIT_2, current_path)
...
def task2():
    ...
    test_spi.run_test_rwr(COMPORT_UNIT_2, current_path)
    
    sf.load_uboot_endtask()

def main():

    test_spi.GPIO_PIN_MOSI = 43
    test_spi.GPIO_PIN_MISO = 44
    test_spi.pinctrl_IP_base = 0x122d0000
    test_spi.pinctrl_doen_base = 0x00
    test_spi.pinctrl_dout_base = 0x30
    test_spi.spi_mo_dout_id = 14
    test_spi.spi_mo_doen_id = 6
    test_spi.gpi_spi_mi_addr = 0x122d0064
